...
class ResponseEntryV1SerializationTest {
    ...
    @Test
    fun serialize() {
        val json = apiEntryV1Mapper.writeValueAsString(response)
    ...
    fun deserialize() {
        val json = apiEntryV1Mapper.writeValueAsString(response)
        val obj = apiEntryV1Mapper.readValue(json, IResponse::class.java) as EntryCreateResponse
