...
С использованием docker-compose запускаются наши приложения (Ktor, RabbitMQ и т.п.), поднимается база данных и тестируется API путем отправки соответствующих запросов и проверки ответов.
